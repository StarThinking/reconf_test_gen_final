...
public class ThriftServer  extends Configured implements Tool {
  ...
  public ThriftServer(Configuration conf) {
    ...
    conf = org.apache.hadoop.conf.Configuration.registerMyComponent(this, "hbase:ThriftServer", conf);
  ...
  protected TProtocolFactory getProtocolFactory() {
    ...
    System.out.println("msx-debug reading " + COMPACT_CONF_KEY + ", which is " + conf.getBoolean(COMPACT_CONF_KEY, COMPACT_CONF_DEFAULT) 
        + " in getProtocolFactory");
  ...
  protected void parseCommandLine(CommandLine cmd, Options options) throws ExitCodeException {
    ...
    System.out.println("msx-debug compact is " + compact + " on ThriftServer");
