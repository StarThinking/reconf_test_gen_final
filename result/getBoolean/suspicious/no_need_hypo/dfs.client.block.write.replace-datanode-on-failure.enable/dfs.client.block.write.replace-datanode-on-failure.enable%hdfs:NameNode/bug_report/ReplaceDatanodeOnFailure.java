...
public class ReplaceDatanodeOnFailure {
  ...
  public void checkEnabled() {
    if (policy == Policy.DISABLE) {
        System.out.println("msx-debug ReplaceDatanodeOnFailure checkEnabled() enabled is false");
  ...
  private static Policy getPolicy(final Configuration conf) {
    ...
    System.out.println("msx-debug ReplaceDatanodeOnFailure getPolicy() enabled is " + enabled);
