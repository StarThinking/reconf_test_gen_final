...
public class ResultVerifier {
  ...
  public static boolean verify(String sample, String source) throws Exception {
    ...
    for (int i = 0; i < sourcepaths.length; i++) {
      ...
      System.out.println("msx-debug sourcepath = " + sourcepath.getName());
      ...
      for (int j = 0; j < samplepaths.length; j++) {
        System.out.println("msx-debug iterating samplepath = " + samplepaths[i].getName());
        if (samplepaths[i].getName().equals(sourcepath.getName())) {
          System.out.println("msx-debug found samplepath = sourcepath = " + samplepath);
